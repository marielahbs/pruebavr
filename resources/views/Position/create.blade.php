  ...
  <div class="col-sm-6">
    ...
    <div class="card">
             <div class="card-header">
                <h4 class="header header-primary text-center">Nuevo Cargo</h4>
             </div>
                ...
                <div class="card-body">
                  ...
                  <p class="text-divider text-center">Ingresa el cargo</p>
                    ...
                    <form method="POST" action="{{ route('position.store') }}" role="form"> {{ csrf_field() }}
                   
                    <div class="form-group">
                      <input type="text" name="name" id="name" class="form-control input-sm" placeholder="Nombre del cargo">
                    </div>
