            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <h4 class="header header-primary text-center icon-plus"> Nuevo Rol</h4></a>
                </div>
                <div class="card-body">
                          ...
                          <tr>
                            ...
                            <div class="row">
                              <div class="col-xs-6 col-sm-6 col-md-6">
                                ...
                                <a type="button" rel="tooltip" title="Editar" class="btn btn-primary btn-round btn-sm" href="{{action('RoleController@edit', $rol->id)}}">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                              <div class="form-group">
                            <form action="{{action('RoleController@destroy', $rol->id)}}" method="post">
