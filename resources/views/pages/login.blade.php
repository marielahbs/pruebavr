            ...
            <div class="card-group">
                <div class="card p-4">
                    <div class="card-body">
                        ...
                        <h1 class="header header-primary text-center">Iniciar Sesión</h1>
                        <p class="text-divider text-center">Ingresa a tu cuenta</p>
                        ...
                        <form method="POST" action="{{ route('login') }}"> {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <a href="{{ route('register') }}" class="btn btn-danger btn-block mt-3">¡Registrate ahora!</a>
                        </form>
                    </div>
